...
namespace ComicStoreDAL
{
    public class StoreInitializer : DropCreateDatabaseAlways<ComicStoreContext>
    {
        protected override void Seed(ComicStoreContext context)
        {
            ...
            var order1 = new Order { Name = NameFaker.FirstName(), LastName = NameFaker.LastName(), OrderDate = DateTime.Now, City = LocationFaker.City(), Country = LocationFaker.Country(), Appartment = LocationFaker.StreetNumber().ToString(), Street = LocationFaker.Street(), PhoneNumber = NumberFaker.Number(), ZipCode = LocationFaker.ZipCode(), TotalPrice = NumberFaker.Number(5, 10), OrderStatus = OrderStatus.Completed, Email = "bart@gmail.com", PaymentMethod = PaymentMethod.DueOnReceipt };
            var order2 = new Order { Name = NameFaker.FirstName(), LastName = NameFaker.LastName(), OrderDate = DateTime.Now, City = LocationFaker.City(), Country = LocationFaker.Country(), Appartment = LocationFaker.StreetNumber().ToString(), Street = LocationFaker.Street(), PhoneNumber = NumberFaker.Number(), ZipCode = LocationFaker.ZipCode(), TotalPrice = NumberFaker.Number(5, 10), OrderStatus = OrderStatus.Completed, Email = "lisa@gmail.com", PaymentMethod = PaymentMethod.PayPal };
            var order3 = new Order { Name = NameFaker.FirstName(), LastName = NameFaker.LastName(), OrderDate = DateTime.Now, City = LocationFaker.City(), Country = LocationFaker.Country(), Appartment = LocationFaker.StreetNumber().ToString(), Street = LocationFaker.Street(), PhoneNumber = NumberFaker.Number(), ZipCode = LocationFaker.ZipCode(), TotalPrice = NumberFaker.Number(5, 10), OrderStatus = OrderStatus.Completed, Email = "homer@gmail.com", PaymentMethod = PaymentMethod.DueOnReceipt };
            var order4 = new Order { Name = NameFaker.FirstName(), LastName = NameFaker.LastName(), OrderDate = DateTime.Now, City = LocationFaker.City(), Country = LocationFaker.Country(), Appartment = LocationFaker.StreetNumber().ToString(), Street = LocationFaker.Street(), PhoneNumber = NumberFaker.Number(), ZipCode = LocationFaker.ZipCode(), TotalPrice = NumberFaker.Number(5, 10), OrderStatus = OrderStatus.Completed, Email = "marge@gmail.com", PaymentMethod = PaymentMethod.DueOnReceipt };
            var order5 = new Order { Name = NameFaker.FirstName(), LastName = NameFaker.LastName(), OrderDate = DateTime.Now, City = LocationFaker.City(), Country = LocationFaker.Country(), Appartment = LocationFaker.StreetNumber().ToString(), Street = LocationFaker.Street(), PhoneNumber = NumberFaker.Number(), ZipCode = LocationFaker.ZipCode(), TotalPrice = NumberFaker.Number(5, 10), OrderStatus = OrderStatus.Completed, Email = "maggie@gamil.com", PaymentMethod = PaymentMethod.PayPal };
